    ...
    <>
        ...
        <PopupWithForm name="profile" title="Редактировать профиль" buttonText="Сохранить" isOpen={isEditProfilePopupOpen} onClose={closeAllPopups}>
            <label className="popup__form-label">
                <input type="text" required className="popup__input" minLength="2" maxLength="40" placeholder="Имя" name="personName" id="person-name" value="" />
                <span className="popup__error person-name-error popup__error-visible"></span>
            </label>
            <label className="popup__form-label">
                <input type="text" required className="popup__input" minLength="2" maxLength="200" placeholder="Профессия" name="personJob" id="person-job" value="" />
        ...
        <PopupWithForm name="place" title="Новое место" buttonText="Создать" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
            <label className="popup__form-label">
                <input type="text" required className="popup__input" minLength="2" maxLength="30" placeholder="Название" name="name" id="name" value="" />
                <span className="popup__error name-error popup__error-visible"></span>
            </label>
            <label className="popup__form-label">
                <input type="url" required className="popup__input" placeholder="Ссылка на картинку" name="link" id="link" value="" />
        ...
        <PopupWithForm name="edit-avatar" title="Обновить аватар" buttonText="Сохранить" isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups}>
            <label className="popup__form-label">
                <input type="url" required className="popup__input" placeholder="Ссылка на картинку" name="avatarLink" id="avatar-link" value="" />
